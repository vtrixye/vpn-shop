...
class Text:
    ...
    def trial_sub():
        return (
            ...
            "> Ваша подписка доступна во владке *Профиль -> Мои подписки*"
        )
    ...
    def sub_revoke():
        return (
            "## ![](tg://emoji?id=5258096772776991776) Сброс ссылки\n\n"
    ...
    def revoke():
        return (
            "## ![](tg://emoji?id=5260416304224936047) Ссылка успешно обновлена\n\n"
            "> Если у вас возникли проблемы с подключением, обратитесь в поддержку @GrapeVpnSupport"
        )
    ...
    def sub_trans():
        return (
            "![🕘](tg://emoji?id=5258331647358540449) Введите Telegram ID пользователя, которому хотите передать подписку  \n"
